---
title: "ConApp - Version Française"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{ConApp - Version Française}
...
Pour les développeurs travaillant avec ce code, consultez [CLAUDE.md](../CLAUDE.html) pour des informations détaillées sur l'architecture, les commandes de développement et les détails d'implémentation.
